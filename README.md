...
| <a name="input_content_based_deduplication_enabled"></a> [content\_based\_deduplication\_enabled](#input\_content\_based\_deduplication\_enabled) | Enables content-based deduplication for FIFO queues. | `bool` | `false` | no |
...
| <a name="input_fifo_queue_enabled"></a> [fifo\_queue\_enabled](#input\_fifo\_queue\_enabled) | Boolean designating a FIFO queue. | `bool` | `false` | no |
